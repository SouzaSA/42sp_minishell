...
void	ft_init_tt_command_io_file_here(void (***tt)(t_list **, enum e_symbol))
{
	...
	tt[NTS_COMMAND1][TS_AND_IF - NUM_NTS] = &ft_epsilon;
	tt[NTS_COMMAND1][TS_OR_IF - NUM_NTS] = &ft_epsilon;
...
void	ft_init_tt_simple_cmd(void (***tt)(t_list **, enum e_symbol))
{
	...
	tt[NTS_SIMPLE_CMD1][TS_AND_IF - NUM_NTS] = &ft_epsilon;
	tt[NTS_SIMPLE_CMD1][TS_OR_IF - NUM_NTS] = &ft_epsilon;
	...
	tt[NTS_SIMPLE_CMD2][TS_AND_IF - NUM_NTS] = &ft_epsilon;
	tt[NTS_SIMPLE_CMD2][TS_OR_IF - NUM_NTS] = &ft_epsilon;
...
void	ft_init_tt_prefix_redirect(void (***tt)(t_list **, enum e_symbol))
{
	...
	tt[NTS_PREFIX1][TS_AND_IF - NUM_NTS] = &ft_epsilon;
	tt[NTS_PREFIX1][TS_OR_IF - NUM_NTS] = &ft_epsilon;
...
void	ft_init_tt_sulfix(void (***tt)(t_list **, enum e_symbol))
{
	...
	tt[NTS_SULFIX1][TS_AND_IF - NUM_NTS] = &ft_epsilon;
	tt[NTS_SULFIX1][TS_OR_IF - NUM_NTS] = &ft_epsilon;
...
void	ft_init_tt_redir_list(void (***tt)(t_list **, enum e_symbol))
{
	...
	tt[NTS_REDIR_LST1][TS_AND_IF - NUM_NTS] = &ft_epsilon;
	tt[NTS_REDIR_LST1][TS_OR_IF - NUM_NTS] = &ft_epsilon;
