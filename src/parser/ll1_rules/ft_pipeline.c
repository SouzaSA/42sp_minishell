...
/*   Updated: 2022/01/25 15:22:36 by sde-alva         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_pipeline(t_syntax *stx_vars, enum e_symbol tok_type)
{
	if (tok_type >= 0)
	{
		...
		ft_lstpush(&stx_vars->symbol_stack, ft_stk_node(NTS_PIPELINE1));
		ft_lstpush(&stx_vars->symbol_stack, ft_stk_node(NTS_COMMAND));
	}
}
