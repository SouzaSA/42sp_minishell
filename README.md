...
```
We put an empty string \'\' to represent the epslon prodution, just be the same as the LL\(1\) parser visualization tool[^pvt], made by Princeton university in the COS 320: Compiling Techniques, Spring 2020, this tool make all tables and draw the parser tree for a given line.
...
[^scl]: [Shell Command Language](https://pubs.opengroup.org/onlinepubs/9699919799/utilities/V3_chap02.html#tag_18_10)

[^pvt]: [LL\(1\) Parser Visualization](https://www.cs.princeton.edu/courses/archive/spring20/cos320/LL1/)
