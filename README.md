...
| | $ | and_if | or_if | pipe | lbrace | rbrace | assign_word
| --- | --- | --- | --- | --- | --- | --- | --- |
S | | | | | S ::= PROGRAM $ | | S ::= PROGRAM $ |
PROGRAM | | | | | PROGRAM ::= AND_OR | | PROGRAM ::= AND_OR |
AND_OR | | | | | AND_OR ::= PIPELINE AND_OR1 | | AND_OR ::= PIPELINE AND_OR1 |
AND_OR1 | AND_OR1 ::= ε | AND_OR1 ::= and_if PIPELINE AND_OR1 | AND_OR1 ::= or_if PIPELINE AND_OR1 | | | AND_OR1 ::= ε | |
PIPELINE | | | | | PIPELINE ::= COMMAND PIPELINE1 | | PIPELINE ::= COMMAND PIPELINE1 |
PIPELINE1 | PIPELINE1 ::= ε | PIPELINE1 ::= ε | PIPELINE1 ::= ε | PIPELINE1 ::= pipe COMMAND | | PIPELINE1 ::= ε | |
COMMAND | | | | | COMMAND ::= SUBSHELL COMMAND1 | | COMMAND ::= SIMPLE_COMMAND |
COMMAND1 | COMMAND1 ::= ε | COMMAND1 ::= ε | COMMAND1 ::= ε | COMMAND1 ::= ε | | COMMAND1 ::= ε | |
SUBSHELL | | | | | SUBSHELL ::= lbrace AND_OR rbrace | | |
SIMPLE_COMMAND | | | | | | | SIMPLE_COMMAND ::= CMD_PREFIX SIMPLE_COMMAND1 |
SIMPLE_COMMAND1 | SIMPLE_COMMAND1 ::= ε | SIMPLE_COMMAND1 ::= ε | SIMPLE_COMMAND1 ::= ε | SIMPLE_COMMAND1 ::= ε | | SIMPLE_COMMAND1 ::= ε | |
SIMPLE_COMMAND2 | SIMPLE_COMMAND2 ::= ε | SIMPLE_COMMAND2 ::= ε | SIMPLE_COMMAND2 ::= ε | SIMPLE_COMMAND2 ::= ε | | SIMPLE_COMMAND2 ::= ε | |
CMD_WORD | | | | | | | |
ASSIGNMENT_WORD | | | | | | | ASSIGNMENT_WORD ::= assign_word |
CMD_PREFIX | | | | | | | CMD_PREFIX ::= ASSIGNMENT_WORD CMD_PREFIX1 |
CMD_PREFIX1 | CMD_PREFIX1 ::= ε | CMD_PREFIX1 ::= ε | CMD_PREFIX1 ::= ε | CMD_PREFIX1 ::= ε | | CMD_PREFIX1 ::= ε | CMD_PREFIX1 ::= ASSIGNMENT_WORD CMD_PREFIX1 |
CMD_SULFIX | | | | | | | |
CMD_SULFIX1 | CMD_SULFIX1 ::= ε | CMD_SULFIX1 ::= ε | CMD_SULFIX1 ::= ε | CMD_SULFIX1 ::= ε | | CMD_SULFIX1 ::= ε | |
REDIRECT_LIST | | | | | | | |
REDIRECT_LIST1 | REDIRECT_LIST1 ::= ε | REDIRECT_LIST1 ::= ε | REDIRECT_LIST1 ::= ε | REDIRECT_LIST1 ::= ε | | REDIRECT_LIST1 ::= ε | |
IO_REDIRECT | | | | | | | |
IO_FILE | | | | | | | |
FILENAME | | | | | | | |
IO_HERE | | | | | | | |
...
### **Transition Table - continuation**

| | less | great | dgreat | lessgreat | dless | word |
|--- | --- | --- | --- | --- | --- | --- |
S | S ::= PROGRAM $ | S ::= PROGRAM $ | S ::= PROGRAM $ | S ::= PROGRAM $ | S ::= PROGRAM $ | S ::= PROGRAM $ |
PROGRAM | PROGRAM ::= AND_OR | PROGRAM ::= AND_OR | PROGRAM ::= AND_OR | PROGRAM ::= AND_OR | PROGRAM ::= AND_OR | PROGRAM ::= AND_OR |
AND_OR | AND_OR ::= PIPELINE AND_OR1 | AND_OR ::= PIPELINE AND_OR1 | AND_OR ::= PIPELINE AND_OR1 | AND_OR ::= PIPELINE AND_OR1 | AND_OR ::= PIPELINE AND_OR1 | AND_OR ::= PIPELINE AND_OR1 |
AND_OR1 | | | | | | |
PIPELINE | PIPELINE ::= COMMAND PIPELINE1 | PIPELINE ::= COMMAND PIPELINE1 | PIPELINE ::= COMMAND PIPELINE1 | PIPELINE ::= COMMAND PIPELINE1 | PIPELINE ::= COMMAND PIPELINE1 | PIPELINE ::= COMMAND PIPELINE1 |
PIPELINE1 | | | | | | |
COMMAND | COMMAND ::= SIMPLE_COMMAND | COMMAND ::= SIMPLE_COMMAND | COMMAND ::= SIMPLE_COMMAND | COMMAND ::= SIMPLE_COMMAND | COMMAND ::= SIMPLE_COMMAND | COMMAND ::= SIMPLE_COMMAND |
COMMAND1 | COMMAND1 ::= REDIRECT_LIST | COMMAND1 ::= REDIRECT_LIST | COMMAND1 ::= REDIRECT_LIST | COMMAND1 ::= REDIRECT_LIST | COMMAND1 ::= REDIRECT_LIST | |
SUBSHELL | | | | | | |
SIMPLE_COMMAND | SIMPLE_COMMAND ::= CMD_PREFIX SIMPLE_COMMAND1 | SIMPLE_COMMAND ::= CMD_PREFIX SIMPLE_COMMAND1 | SIMPLE_COMMAND ::= CMD_PREFIX SIMPLE_COMMAND1 | SIMPLE_COMMAND ::= CMD_PREFIX SIMPLE_COMMAND1 | SIMPLE_COMMAND ::= CMD_PREFIX SIMPLE_COMMAND1 | SIMPLE_COMMAND ::= CMD_WORD SIMPLE_COMMAND2 |
SIMPLE_COMMAND1 | | | | | | SIMPLE_COMMAND1 ::= CMD_WORD SIMPLE_COMMAND2 |
SIMPLE_COMMAND2 | SIMPLE_COMMAND2 ::= CMD_SULFIX | SIMPLE_COMMAND2 ::= CMD_SULFIX | SIMPLE_COMMAND2 ::= CMD_SULFIX | SIMPLE_COMMAND2 ::= CMD_SULFIX | SIMPLE_COMMAND2 ::= CMD_SULFIX | SIMPLE_COMMAND2 ::= CMD_SULFIX |
CMD_WORD | | | | | | CMD_WORD ::= WORD |
ASSIGNMENT_WORD | | | | | | |
CMD_PREFIX | CMD_PREFIX ::= IO_REDIRECT CMD_PREFIX1 | CMD_PREFIX ::= IO_REDIRECT CMD_PREFIX1 | CMD_PREFIX ::= IO_REDIRECT CMD_PREFIX1 | CMD_PREFIX ::= IO_REDIRECT CMD_PREFIX1 | CMD_PREFIX ::= IO_REDIRECT CMD_PREFIX1 | |
CMD_PREFIX1 | CMD_PREFIX1 ::= IO_REDIRECT CMD_PREFIX1 | CMD_PREFIX1 ::= IO_REDIRECT CMD_PREFIX1 | CMD_PREFIX1 ::= IO_REDIRECT CMD_PREFIX1 | CMD_PREFIX1 ::= IO_REDIRECT CMD_PREFIX1 | CMD_PREFIX1 ::= IO_REDIRECT CMD_PREFIX1 | CMD_PREFIX1 ::= ε |
...
CMD_SULFIX1 | CMD_SULFIX1 ::= IO_REDIRECT CMD_SULFIX1 | CMD_SULFIX1 ::= IO_REDIRECT CMD_SULFIX1 | CMD_SULFIX1 ::= IO_REDIRECT CMD_SULFIX1 | CMD_SULFIX1 ::= IO_REDIRECT CMD_SULFIX1 | CMD_SULFIX1 ::= IO_REDIRECT CMD_SULFIX1 | CMD_SULFIX1 ::= WORD CMD_SULFIX1 |
...
REDIRECT_LIST1 | REDIRECT_LIST1 ::= IO_REDIRECT REDIRECT_LIST1 | REDIRECT_LIST1 ::= IO_REDIRECT REDIRECT_LIST1 | REDIRECT_LIST1 ::= IO_REDIRECT REDIRECT_LIST1 | REDIRECT_LIST1 ::= IO_REDIRECT REDIRECT_LIST1 | REDIRECT_LIST1 ::= IO_REDIRECT REDIRECT_LIST1 | |
